...
export default function Postcard({ heading, content, date, pin, badge }: any) {
  ...
  return (
    <div className="mb-5">
      ...
      >
        <div className="absolute top-2 right-2 ">{pin}</div>
        ...
        {/* heading post */}
        <p className="pl-2 text-neutral-600 dark:text-neutral-300">{heading}</p>
        ...
        <div className="mt-3 flex justify-between text-neutral-600">
          <div className="group gap-1 flex">{badge}</div>
          {date}
        </div>
      </Card>
    </div>
